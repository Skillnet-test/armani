...
/**
 *
 * This class is an object representation of the Arts database table ARM_STG_TXN_DTL<BR>
...
public String getRecordType() { return this.recordType; }
  ...
  public Double getMrk() {	return mrk;}
public void setMrk(Double mrk) {	this.mrk = mrk;}

public Double getMrk_per() {	return mrk_per;}
public void setMrk_per(Double mrk_per) {	this.mrk_per = mrk_per;}

public Double getRed_amt2() {	return red_amt2;}
public void setRed_amt2(Double red_amt2) {	this.red_amt2 = red_amt2;}

public Double getDsc_per2() {	return dsc_per2;}
public void setDsc_per2(Double dsc_per2) {	this.dsc_per2 = dsc_per2;}

public Double getPrz_Retail() {	return prz_Retail;}
public void setPrz_Retail(Double prz_Retail) {	this.prz_Retail = prz_Retail;}
...
public void setRecordType(String recordType) { this.recordType = recordType; }
  ...
  public void setLineId(long lineId) { this.lineId = new Long(lineId); }
  public void setLineId(int lineId) { this.lineId = new Long((long)lineId); }

  public Long getLineSeqNum() { return this.lineSeqNum; }
  public void setLineSeqNum(Long lineSeqNum) { this.lineSeqNum = lineSeqNum; }
  public void setLineSeqNum(long lineSeqNum) { this.lineSeqNum = new Long(lineSeqNum); }
  public void setLineSeqNum(int lineSeqNum) { this.lineSeqNum = new Long((long)lineSeqNum); }

  public String getLineItemType() { return this.lineItemType; }
  ...
  public String getMiscItemTxbl() { return this.miscItemTxbl; }
  public void setMiscItemTxbl(String miscItemTxbl) { this.miscItemTxbl = miscItemTxbl; }
  ...
  public Double getItmRtlPrice() { return this.itmRtlPrice; }
  public void setItmRtlPrice(Double itmRtlPrice) { this.itmRtlPrice = itmRtlPrice; }
  public void setItmRtlPrice(double itmRtlPrice) { this.itmRtlPrice = new Double(itmRtlPrice); }

  public Double getItmSelPrice() { return this.itmSelPrice; }
  public void setItmSelPrice(Double itmSelPrice) { this.itmSelPrice = itmSelPrice; }
  public void setItmSelPrice(double itmSelPrice) { this.itmSelPrice = new Double(itmSelPrice); }

  public Double getManualMdAmt() { return this.manualMdAmt; }
  public void setManualMdAmt(Double manualMdAmt) { this.manualMdAmt = manualMdAmt; }
  public void setManualMdAmt(double manualMdAmt) { this.manualMdAmt = new Double(manualMdAmt); }

  public Double getManualUnitPrice() { return this.manualUnitPrice; }
  public void setManualUnitPrice(Double manualUnitPrice) { this.manualUnitPrice = manualUnitPrice; }
  public void setManualUnitPrice(double manualUnitPrice) { this.manualUnitPrice = new Double(manualUnitPrice); }
  ...
  public String getShipState() { return this.shipState; }
  public void setShipState(String shipState) { this.shipState = shipState; }

  public String getShipZipCode() { return this.shipZipCode; }
  public void setShipZipCode(String shipZipCode) { this.shipZipCode = shipZipCode; }

  public Double getNetAmt() { return this.netAmt; }
  public void setNetAmt(Double netAmt) { this.netAmt = netAmt; }
  public void setNetAmt(double netAmt) { this.netAmt = new Double(netAmt); }

  public Double getTaxAmt() { return this.taxAmt; }
  public void setTaxAmt(Double taxAmt) { this.taxAmt = taxAmt; }
  public void setTaxAmt(double taxAmt) { this.taxAmt = new Double(taxAmt); }

  public Double getManualTaxAmt() { return this.manualTaxAmt; }
  public void setManualTaxAmt(Double manualTaxAmt) { this.manualTaxAmt = manualTaxAmt; }
  public void setManualTaxAmt(double manualTaxAmt) { this.manualTaxAmt = new Double(manualTaxAmt); }

  public String getExceptionTaxJur() { return this.exceptionTaxJur; }
  public void setExceptionTaxJur(String exceptionTaxJur) { this.exceptionTaxJur = exceptionTaxJur; }

  public Double getDealMkdnAmt() { return this.dealMkdnAmt; }
  public void setDealMkdnAmt(Double dealMkdnAmt) { this.dealMkdnAmt = dealMkdnAmt; }
  public void setDealMkdnAmt(double dealMkdnAmt) { this.dealMkdnAmt = new Double(dealMkdnAmt); }

  public String getDealId() { return this.dealId; }
  public void setDealId(String dealId) { this.dealId = dealId; }

  public String getRtnSaleAiTrn() { return this.rtnSaleAiTrn; }
  public void setRtnSaleAiTrn(String rtnSaleAiTrn) { this.rtnSaleAiTrn = rtnSaleAiTrn; }

  public String getRtnOrigStoreId() { return this.rtnOrigStoreId; }
  public void setRtnOrigStoreId(String rtnOrigStoreId) { this.rtnOrigStoreId = rtnOrigStoreId; }

  public Date getRtnOrigProcessDt() { return this.rtnOrigProcessDt; }
  public void setRtnOrigProcessDt(Date rtnOrigProcessDt) { this.rtnOrigProcessDt = rtnOrigProcessDt; }

  public String getRtnOrigOprId() { return this.rtnOrigOprId; }
  public void setRtnOrigOprId(String rtnOrigOprId) { this.rtnOrigOprId = rtnOrigOprId; }

  public String getRtnOrigRegisterId() { return this.rtnOrigRegisterId; }
  public void setRtnOrigRegisterId(String rtnOrigRegisterId) { this.rtnOrigRegisterId = rtnOrigRegisterId; }

  public String getOrigTransactionId() { return this.origTransactionId; }
  public void setOrigTransactionId(String origTransactionId) { this.origTransactionId = origTransactionId; }

  public String getOrigAddNo() { return this.origAddNo; }
  public void setOrigAddNo(String origAddNo) { this.origAddNo = origAddNo; }
  ...
  public String getReductionReason() { return this.reductionReason; }
  public void setReductionReason(String reductionReason) { this.reductionReason = reductionReason; }

  public Double getDscAmount() { return this.dscAmount; }
  public void setDscAmount(Double dscAmount) { this.dscAmount = dscAmount; }
  public void setDscAmount(double dscAmount) { this.dscAmount = new Double(dscAmount); }

  public Double getDscPercent() { return this.dscPercent; }
  public void setDscPercent(Double dscPercent) { this.dscPercent = dscPercent; }
  public void setDscPercent(double dscPercent) { this.dscPercent = new Double(dscPercent); }

  public String getDscReason() { return this.dscReason; }
  public void setDscReason(String dscReason) { this.dscReason = dscReason; }

  public String getDscEmployeeId() { return this.dscEmployeeId; }
  public void setDscEmployeeId(String dscEmployeeId) { this.dscEmployeeId = dscEmployeeId; }

  public String getDscAdvertisingCode() { return this.dscAdvertisingCode; }
  public void setDscAdvertisingCode(String dscAdvertisingCode) { this.dscAdvertisingCode = dscAdvertisingCode; }

  public String getDscIsDscPercent() { return this.dscIsDscPercent; }
  public void setDscIsDscPercent(String dscIsDscPercent) { this.dscIsDscPercent = dscIsDscPercent; }

  public String getTndType() { return this.tndType; }
  public void setTndType(String tndType) { this.tndType = tndType; }

  public String getTndCode() { return this.tndCode; }
  public void setTndCode(String tndCode) { this.tndCode = tndCode; }

  public Double getTndAmount() { return this.tndAmount; }
  public void setTndAmount(Double tndAmount) { this.tndAmount = tndAmount; }
  public void setTndAmount(double tndAmount) { this.tndAmount = new Double(tndAmount); }

  public String getTndIdAcntNmb() { return this.tndIdAcntNmb; }
  public void setTndIdAcntNmb(String tndIdAcntNmb) { this.tndIdAcntNmb = tndIdAcntNmb; }

  public String getTndRespAuth() { return this.tndRespAuth; }
  public void setTndRespAuth(String tndRespAuth) { this.tndRespAuth = tndRespAuth; }

  public Date getTndApprovalDate() { return this.tndApprovalDate; }
  public void setTndApprovalDate(Date tndApprovalDate) { this.tndApprovalDate = tndApprovalDate; }

  public Date getTndExpirationDt() { return this.tndExpirationDt; }
  public void setTndExpirationDt(Date tndExpirationDt) { this.tndExpirationDt = tndExpirationDt; }

  public String getTndHolderName() { return this.tndHolderName; }
  public void setTndHolderName(String tndHolderName) { this.tndHolderName = tndHolderName; }

  public String getTndManualOverride() { return this.tndManualOverride; }
  public void setTndManualOverride(String tndManualOverride) { this.tndManualOverride = tndManualOverride; }

  public String getChkAbaNum() { return this.chkAbaNum; }
  public void setChkAbaNum(String chkAbaNum) { this.chkAbaNum = chkAbaNum; }

  public String getChkRoutingNum() { return this.chkRoutingNum; }
  public void setChkRoutingNum(String chkRoutingNum) { this.chkRoutingNum = chkRoutingNum; }

  public String getChkBank() { return this.chkBank; }
  public void setChkBank(String chkBank) { this.chkBank = chkBank; }

  public String getChkIsScanned() { return this.chkIsScanned; }
  public void setChkIsScanned(String chkIsScanned) { this.chkIsScanned = chkIsScanned; }

  public String getCcCvvCode() { return this.ccCvvCode; }
  public void setCcCvvCode(String ccCvvCode) { this.ccCvvCode = ccCvvCode; }

  public String getCcAmexCidNum() { return this.ccAmexCidNum; }
  public void setCcAmexCidNum(String ccAmexCidNum) { this.ccAmexCidNum = ccAmexCidNum; }

  public String getRdmControlNumber() { return this.rdmControlNumber; }
  public void setRdmControlNumber(String rdmControlNumber) { this.rdmControlNumber = rdmControlNumber; }

  public String getTndSwipeInd() { return this.tndSwipeInd; }
  public void setTndSwipeInd(String tndSwipeInd) { this.tndSwipeInd = tndSwipeInd; }

  public String getTndRespAddressVerif() { return this.tndRespAddressVerif; }
  public void setTndRespAddressVerif(String tndRespAddressVerif) { this.tndRespAddressVerif = tndRespAddressVerif; }

  public String getTndRespJournalKey() { return this.tndRespJournalKey; }
  public void setTndRespJournalKey(String tndRespJournalKey) { this.tndRespJournalKey = tndRespJournalKey; }

  public String getTndRespMsg() { return this.tndRespMsg; }
  public void setTndRespMsg(String tndRespMsg) { this.tndRespMsg = tndRespMsg; }

  public String getTndRespMsgNum() { return this.tndRespMsgNum; }
  public void setTndRespMsgNum(String tndRespMsgNum) { this.tndRespMsgNum = tndRespMsgNum; }

  public String getTndMerchantId() { return this.tndMerchantId; }
  public void setTndMerchantId(String tndMerchantId) { this.tndMerchantId = tndMerchantId; }

  public String getTndCardIdentifier() { return this.tndCardIdentifier; }
  public void setTndCardIdentifier(String tndCardIdentifier) { this.tndCardIdentifier = tndCardIdentifier; }

  public String getCcCardPlan() { return this.ccCardPlan; }
  public void setCcCardPlan(String ccCardPlan) { this.ccCardPlan = ccCardPlan; }

  public String getRdmTndIdStrRt() { return this.rdmTndIdStrRt; }
  public void setRdmTndIdStrRt(String rdmTndIdStrRt) { this.rdmTndIdStrRt = rdmTndIdStrRt; }

  public String getRdmDcCpnScanCode() { return this.rdmDcCpnScanCode; }
  public void setRdmDcCpnScanCode(String rdmDcCpnScanCode) { this.rdmDcCpnScanCode = rdmDcCpnScanCode; }

  public String getRdmTndPrmCode() { return this.rdmTndPrmCode; }
  public void setRdmTndPrmCode(String rdmTndPrmCode) { this.rdmTndPrmCode = rdmTndPrmCode; }

  public Date getRdmExpirationDate() { return this.rdmExpirationDate; }
  public void setRdmExpirationDate(Date rdmExpirationDate) { this.rdmExpirationDate = rdmExpirationDate; }

  public Double getFcXchangeRate() { return this.fcXchangeRate; }
  public void setFcXchangeRate(Double fcXchangeRate) { this.fcXchangeRate = fcXchangeRate; }
  public void setFcXchangeRate(double fcXchangeRate) { this.fcXchangeRate = new Double(fcXchangeRate); }

  public String getFcFromCurrency() { return this.fcFromCurrency; }
  public void setFcFromCurrency(String fcFromCurrency) { this.fcFromCurrency = fcFromCurrency; }

  public String getFcToCurrency() { return this.fcToCurrency; }
  public void setFcToCurrency(String fcToCurrency) { this.fcToCurrency = fcToCurrency; }

  public String getRdmType() { return this.rdmType; }
  public void setRdmType(String rdmType) { this.rdmType = rdmType; }

  public String getRdmIssuingStore() { return this.rdmIssuingStore; }
  public void setRdmIssuingStore(String rdmIssuingStore) { this.rdmIssuingStore = rdmIssuingStore; }

  public String getRdmCustNum() { return this.rdmCustNum; }
  public void setRdmCustNum(String rdmCustNum) { this.rdmCustNum = rdmCustNum; }

  public Date getRdmIssuanceDt() { return this.rdmIssuanceDt; }
  public void setRdmIssuanceDt(Date rdmIssuanceDt) { this.rdmIssuanceDt = rdmIssuanceDt; }

  public Date getRdmExpirationDt() { return this.rdmExpirationDt; }
  public void setRdmExpirationDt(Date rdmExpirationDt) { this.rdmExpirationDt = rdmExpirationDt; }

  public Double getRdmFaceValueAmt() { return this.rdmFaceValueAmt; }
  public void setRdmFaceValueAmt(Double rdmFaceValueAmt) { this.rdmFaceValueAmt = rdmFaceValueAmt; }
  public void setRdmFaceValueAmt(double rdmFaceValueAmt) { this.rdmFaceValueAmt = new Double(rdmFaceValueAmt); }

  public Double getRdmBalanceAmt() { return this.rdmBalanceAmt; }
  public void setRdmBalanceAmt(Double rdmBalanceAmt) { this.rdmBalanceAmt = rdmBalanceAmt; }
  public void setRdmBalanceAmt(double rdmBalanceAmt) { this.rdmBalanceAmt = new Double(rdmBalanceAmt); }

  public Double getRdmBuybackAmt() { return this.rdmBuybackAmt; }
  public void setRdmBuybackAmt(Double rdmBuybackAmt) { this.rdmBuybackAmt = rdmBuybackAmt; }
  public void setRdmBuybackAmt(double rdmBuybackAmt) { this.rdmBuybackAmt = new Double(rdmBuybackAmt); }

  public String getRdmBuybackComment() { return this.rdmBuybackComment; }
  public void setRdmBuybackComment(String rdmBuybackComment) { this.rdmBuybackComment = rdmBuybackComment; }

  public String getPostVoidedTransNo() { return this.postVoidedTransNo; }
  public void setPostVoidedTransNo(String postVoidedTransNo) { this.postVoidedTransNo = postVoidedTransNo; }

  public String getPostVoidReason() { return this.postVoidReason; }
  public void setPostVoidReason(String postVoidReason) { this.postVoidReason = postVoidReason; }

  public String getPostVoidRegister() { return this.postVoidRegister; }
  public void setPostVoidRegister(String postVoidRegister) { this.postVoidRegister = postVoidRegister; }
  ...
  public String getCustAddr1() { return this.custAddr1; }
  public void setCustAddr1(String custAddr1) { this.custAddr1 = custAddr1; }

  public String getCustAddr2() { return this.custAddr2; }
  public void setCustAddr2(String custAddr2) { this.custAddr2 = custAddr2; }

  public String getCustCity() { return this.custCity; }
  public void setCustCity(String custCity) { this.custCity = custCity; }

  public String getCustState() { return this.custState; }
  public void setCustState(String custState) { this.custState = custState; }

  public String getCustCountry() { return this.custCountry; }
  public void setCustCountry(String custCountry) { this.custCountry = custCountry; }

  public String getCustPcode() { return this.custPcode; }
  public void setCustPcode(String custPcode) { this.custPcode = custPcode; }

  public String getCustPhone1() { return this.custPhone1; }
  public void setCustPhone1(String custPhone1) { this.custPhone1 = custPhone1; }

  public String getCustPhone2() { return this.custPhone2; }
  public void setCustPhone2(String custPhone2) { this.custPhone2 = custPhone2; }

  public String getCashierTxnComment() { return this.cashierTxnComment; }
  public void setCashierTxnComment(String cashierTxnComment) { this.cashierTxnComment = cashierTxnComment; }

  public String getCashierTxnReason() { return this.cashierTxnReason; }
  public void setCashierTxnReason(String cashierTxnReason) { this.cashierTxnReason = cashierTxnReason; }

  public Double getOpeningDrwrFnd() { return this.openingDrwrFnd; }
  public void setOpeningDrwrFnd(Double openingDrwrFnd) { this.openingDrwrFnd = openingDrwrFnd; }
  public void setOpeningDrwrFnd(double openingDrwrFnd) { this.openingDrwrFnd = new Double(openingDrwrFnd); }

  public String getEodTndType() { return this.eodTndType; }
  public void setEodTndType(String eodTndType) { this.eodTndType = eodTndType; }

  public String getEodTndTotal() { return this.eodTndTotal; }
  public void setEodTndTotal(String eodTndTotal) { this.eodTndTotal = eodTndTotal; }

  public String getNotInFileSkuDtl() { return this.notInFileSkuDtl; }
  public void setNotInFileSkuDtl(String notInFileSkuDtl) { this.notInFileSkuDtl = notInFileSkuDtl; }
  ...
  public String getOrigLineItemType() { return this.origLineItemType; }
  public void setOrigLineItemType(String origLineItemType) { this.origLineItemType = origLineItemType; }

  public String getEodReportedTndTotal() { return this.eodReportedTndTotal; }
  public void setEodReportedTndTotal(String eodReportedTndTotal) { this.eodReportedTndTotal = eodReportedTndTotal; }

  public String getExtendedBarcode() { return this.extendedBarcode; }
  public void setExtendedBarcode(String extendedBarcode) { this.extendedBarcode = extendedBarcode; }
  ...
  public BaseOracleBean[] getDatabeans(ResultSet rs) throws SQLException {
    ...
    while(rs.next()) {
      ...
      bean.manualUnitPrice = getDoubleFromResultSet(rs, "MANUAL_UNIT_PRICE");
      ...
      bean.exceptionTaxJur = getStringFromResultSet(rs, "EXCEPTION_TAX_JUR");
      ...
      bean.rtnOrigStoreId = getStringFromResultSet(rs, "RTN_ORIG_STORE_ID");
      bean.rtnOrigProcessDt = getDateFromResultSet(rs, "RTN_ORIG_PROCESS_DT");
      bean.rtnOrigOprId = getStringFromResultSet(rs, "RTN_ORIG_OPR_ID");
      bean.rtnOrigRegisterId = getStringFromResultSet(rs, "RTN_ORIG_REGISTER_ID");
      bean.origTransactionId = getStringFromResultSet(rs, "ORIG_TRANSACTION_ID");
      bean.origAddNo = getStringFromResultSet(rs, "ORIG_ADD_NO");
      bean.reductionAmount = getDoubleFromResultSet(rs, "REDUCTION_AMOUNT");
      bean.reductionReason = getStringFromResultSet(rs, "REDUCTION_REASON");
      ...
      bean.dscAdvertisingCode = getStringFromResultSet(rs, "DSC_ADVERTISING_CODE");
      bean.dscIsDscPercent = getStringFromResultSet(rs, "DSC_IS_DSC_PERCENT");
      ...
      bean.tndManualOverride = getStringFromResultSet(rs, "TND_MANUAL_OVERRIDE");
      ...
      bean.rdmControlNumber = getStringFromResultSet(rs, "RDM_CONTROL_NUMBER");
      bean.tndSwipeInd = getStringFromResultSet(rs, "TND_SWIPE_IND");
      bean.tndRespAddressVerif = getStringFromResultSet(rs, "TND_RESP_ADDRESS_VERIF");
      bean.tndRespJournalKey = getStringFromResultSet(rs, "TND_RESP_JOURNAL_KEY");
      ...
      bean.tndCardIdentifier = getStringFromResultSet(rs, "TND_CARD_IDENTIFIER");
      bean.ccCardPlan = getStringFromResultSet(rs, "CC_CARD_PLAN");
      bean.rdmTndIdStrRt = getStringFromResultSet(rs, "RDM_TND_ID_STR_RT");
      bean.rdmDcCpnScanCode = getStringFromResultSet(rs, "RDM_DC_CPN_SCAN_CODE");
      bean.rdmTndPrmCode = getStringFromResultSet(rs, "RDM_TND_PRM_CODE");
      bean.rdmExpirationDate = getDateFromResultSet(rs, "RDM_EXPIRATION_DATE");
      ...
      bean.rdmIssuingStore = getStringFromResultSet(rs, "RDM_ISSUING_STORE");
      ...
      bean.rdmFaceValueAmt = getDoubleFromResultSet(rs, "RDM_FACE_VALUE_AMT");
      bean.rdmBalanceAmt = getDoubleFromResultSet(rs, "RDM_BALANCE_AMT");
      bean.rdmBuybackAmt = getDoubleFromResultSet(rs, "RDM_BUYBACK_AMT");
      bean.rdmBuybackComment = getStringFromResultSet(rs, "RDM_BUYBACK_COMMENT");
      bean.postVoidedTransNo = getStringFromResultSet(rs, "POST_VOIDED_TRANS_NO");
      bean.postVoidReason = getStringFromResultSet(rs, "POST_VOID_REASON");
      bean.postVoidRegister = getStringFromResultSet(rs, "POST_VOID_REGISTER");
      ...
      bean.cashierTxnComment = getStringFromResultSet(rs, "CASHIER_TXN_COMMENT");
      bean.cashierTxnReason = getStringFromResultSet(rs, "CASHIER_TXN_REASON");
      ...
      bean.notInFileSkuDtl = getStringFromResultSet(rs, "NOT_IN_FILE_SKU_DTL");
      ...
      bean.origLineItemType = getStringFromResultSet(rs, "ORIG_LINE_ITEM_TYPE");
      bean.eodReportedTndTotal = getStringFromResultSet(rs, "EOD_REPORTED_TND_TOTAL");
      bean.extendedBarcode = getStringFromResultSet(rs, "EXTENDED_BARCODE");
      //added by shushma for promotion code
    ...
    return (ArmStgTxnDtlOracleBean[]) list.toArray(new ArmStgTxnDtlOracleBean[0]);
  }
