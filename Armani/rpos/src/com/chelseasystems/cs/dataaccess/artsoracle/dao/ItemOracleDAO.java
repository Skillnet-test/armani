...
public class ItemOracleDAO extends BaseOracleDAO
  ...
  * @return CMSItem[]
  */
  public CMSItem[] selectByDescriptionAndStoreId (String key, String storeId) throws SQLException {
    return  (CMSItem[])itemVwDao.selectByDescriptionAndStoreId(key, storeId);
  }
