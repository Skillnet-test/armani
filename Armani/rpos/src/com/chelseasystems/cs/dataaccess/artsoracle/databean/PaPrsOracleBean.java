...
public class PaPrsOracleBean extends BaseOracleBean {
 ...
 //MODIFIED BY VISHAL YEVALE
  ...
  //public static String COL_SOC_SEC_NO = "PA_PRS.SOC_SEC_NO";
 ...
 // private String socSecNo;
  ...
  /*public String getSocSecNo() { return this.socSecNo; }
  public void setSocSecNo(String socSecNo) { this.socSecNo = socSecNo; }*/
  ...
  public BaseOracleBean[] getDatabeans(ResultSet rs) throws SQLException {
    ...
    while(rs.next()) {
     ...
     // bean.socSecNo = getStringFromResultSet(rs, "SOC_SEC_NO");
      list.add(bean);
    }
  ...
  public List toList() {
    ...
    //addToList(list, this.getSocSecNo(), Types.VARCHAR);
    return list;
  }
