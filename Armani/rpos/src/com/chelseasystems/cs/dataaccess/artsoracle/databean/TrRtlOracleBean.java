...
public class TrRtlOracleBean extends BaseOracleBean {
  ...
  public Long getInRngElpsd() { return this.inRngElpsd; }
  public void setInRngElpsd(Long inRngElpsd) { this.inRngElpsd = inRngElpsd; }
  public void setInRngElpsd(long inRngElpsd) { this.inRngElpsd = new Long(inRngElpsd); }
  public void setInRngElpsd(int inRngElpsd) { this.inRngElpsd = new Long((long)inRngElpsd); }

  public Long getInTndElpsd() { return this.inTndElpsd; }
  public void setInTndElpsd(Long inTndElpsd) { this.inTndElpsd = inTndElpsd; }
  public void setInTndElpsd(long inTndElpsd) { this.inTndElpsd = new Long(inTndElpsd); }
  public void setInTndElpsd(int inTndElpsd) { this.inTndElpsd = new Long((long)inTndElpsd); }

  public Long getInElpsdIdl() { return this.inElpsdIdl; }
  public void setInElpsdIdl(Long inElpsdIdl) { this.inElpsdIdl = inElpsdIdl; }
  public void setInElpsdIdl(long inElpsdIdl) { this.inElpsdIdl = new Long(inElpsdIdl); }
  public void setInElpsdIdl(int inElpsdIdl) { this.inElpsdIdl = new Long((long)inElpsdIdl); }

  public Long getInLckElpsd() { return this.inLckElpsd; }
  public void setInLckElpsd(Long inLckElpsd) { this.inLckElpsd = inLckElpsd; }
  public void setInLckElpsd(long inLckElpsd) { this.inLckElpsd = new Long(inLckElpsd); }
  public void setInLckElpsd(int inLckElpsd) { this.inLckElpsd = new Long((long)inLckElpsd); }

  public Long getQuItmLnSc() { return this.quItmLnSc; }
  public void setQuItmLnSc(Long quItmLnSc) { this.quItmLnSc = quItmLnSc; }
  public void setQuItmLnSc(long quItmLnSc) { this.quItmLnSc = new Long(quItmLnSc); }
  public void setQuItmLnSc(int quItmLnSc) { this.quItmLnSc = new Long((long)quItmLnSc); }

  public Long getQuItmLnKy() { return this.quItmLnKy; }
  public void setQuItmLnKy(Long quItmLnKy) { this.quItmLnKy = quItmLnKy; }
  public void setQuItmLnKy(long quItmLnKy) { this.quItmLnKy = new Long(quItmLnKy); }
  public void setQuItmLnKy(int quItmLnKy) { this.quItmLnKy = new Long((long)quItmLnKy); }

  public Double getPeItmLnSc() { return this.peItmLnSc; }
  public void setPeItmLnSc(Double peItmLnSc) { this.peItmLnSc = peItmLnSc; }
  public void setPeItmLnSc(double peItmLnSc) { this.peItmLnSc = new Double(peItmLnSc); }

  public Double getPeItmLnKy() { return this.peItmLnKy; }
  public void setPeItmLnKy(Double peItmLnKy) { this.peItmLnKy = peItmLnKy; }
  public void setPeItmLnKy(double peItmLnKy) { this.peItmLnKy = new Double(peItmLnKy); }

  public String getIdCt() { return this.idCt; }
  public void setIdCt(String idCt) { this.idCt = idCt; }

  public Long getQuDptKy() { return this.quDptKy; }
  public void setQuDptKy(Long quDptKy) { this.quDptKy = quDptKy; }
  public void setQuDptKy(long quDptKy) { this.quDptKy = new Long(quDptKy); }
  public void setQuDptKy(int quDptKy) { this.quDptKy = new Long((long)quDptKy); }

  public Double getPeDptKy() { return this.peDptKy; }
  public void setPeDptKy(Double peDptKy) { this.peDptKy = peDptKy; }
  public void setPeDptKy(double peDptKy) { this.peDptKy = new Double(peDptKy); }
  ...
  public String getRegTaxExmpId() { return this.regTaxExmpId; }
  public void setRegTaxExmpId(String regTaxExmpId) { this.regTaxExmpId = regTaxExmpId; }

  public String getNotRtnReason() { return this.notRtnReason; }
  public void setNotRtnReason(String notRtnReason) { this.notRtnReason = notRtnReason; }
  ...
  public Boolean getLoyaltyTruncated() { return this.loyaltyTruncated; }
  public void setLoyaltyTruncated(Boolean loyaltyTruncated) { this.loyaltyTruncated = loyaltyTruncated; }
  public void setLoyaltyTruncated(boolean loyaltyTruncated) { this.loyaltyTruncated = new Boolean(loyaltyTruncated); }

  public String getLoyaltyCardNum() { return this.loyaltyCardNum; }
  ...
  public Long getLoyaltyPointsEarned() { return this.loyaltyPointsEarned; }
  public void setLoyaltyPointsEarned(Long loyaltyPointsEarned) { this.loyaltyPointsEarned = loyaltyPointsEarned; }
  public void setLoyaltyPointsEarned(long loyaltyPointsEarned) { this.loyaltyPointsEarned = new Long(loyaltyPointsEarned); }
  public void setLoyaltyPointsEarned(int loyaltyPointsEarned) { this.loyaltyPointsEarned = new Long((long)loyaltyPointsEarned); }
  ...
  public BaseOracleBean[] getDatabeans(ResultSet rs) throws SQLException {
    ...
    while(rs.next()) {
      ...
      bean.loyaltyTruncated = getBooleanFromResultSet(rs, "LOYALTY_TRUNCATED");
      ...
      bean.loyaltyPointsEarned = getLongFromResultSet(rs, "LOYALTY_POINTS_EARNED");
      // Added by Satin for digital signature
      bean.digitalSignature = getStringFromResultSet(rs, "DIGITAL_SIGNATURE");
      //Added by Rachana for approval of return transaction
