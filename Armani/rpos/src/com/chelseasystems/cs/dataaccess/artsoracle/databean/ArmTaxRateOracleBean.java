...
public class ArmTaxRateOracleBean extends BaseOracleBean {
 ...
 // public static String selectSql = "select ZIP_CODE, CITY, COUNTY, STATE, TAX_RATE, EFFECTIVE_DT, TAX_JUR, NATION, TAX_TYPE, EXPIRATION_DT from ARM_TAX_RATE ";
  public static String selectSql = "select ZIP_CODE, CITY, COUNTY, STATE, TAX_RATE, EFFECTIVE_DT, TAX_JUR, NATION, TAX_TYPE from ARM_TAX_RATE ";
 ...
 // private Date expiration_dt;
  ...
  //Poonam: start-Added for expiration date issue on Nov 15,2016
 // public Date getExpiration_dt() {return expiration_dt;}
  //public void setExpiration_dt(Date expiration_dt) {this.expiration_dt = expiration_dt;	}
  //Poonam: end-Added for expiration date issue on Nov 15,2016
