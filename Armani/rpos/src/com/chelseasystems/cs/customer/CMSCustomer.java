...
public class CMSCustomer extends Customer implements com.chelseasystems.cr.rules.IRuleEngine {
  ...
  // PA_PRS (Person)
  String title, middleName, dbFirstName, dbLastName, suffix, gender,socialSecurityNo;
...
//  }
   ...
   */
	...
	/**
	   * This method is used to set socialsecurityno  for the customer
	   * @param val String
	 */
	public void doSocialSecurityNo(String val) {
	    this.socialSecurityNo = val;
	}
