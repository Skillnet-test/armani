...
public class CMSItemFileServices extends CMSItemServices {
	...
	/**
    vishal Yevale :(SAP_LOOKUP)
	 * This method is used to find items by its description for a given store
	 * 
	 * @param theMgr
	 *            IRepositoryManager
	 * @param model , fabric or color and storeid returns String array of Item id's of an resulted item's.	 */
	public String[] findIDListByModel(String model, String fabric,String color, String storeId) throws java.lang.Exception {
		return null;
	}
	...
	public String[] findIDListByDescription(String key, String storeId) throws java.lang.Exception {
		return null;
	}
	/**
