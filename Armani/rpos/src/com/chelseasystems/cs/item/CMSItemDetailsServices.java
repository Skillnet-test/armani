...
public class CMSItemDetailsServices extends CMSItemServices {
	...
	public String[] findIDListByModel(String model, String fabric,String color, String storeId) throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	public String[] findIDListByDescription(String key, String storeId) throws Exception {
		return null;
	}
	/**
