...
public class CustomerMiscInfoPanel extends JPanel {
	...
	/**
	 * added by vishal yevale
	 * changed by saptarshi mukhaty
	 */
	private JCMSLabel lblSocialSecurityNo;
	private JCMSTextField txtSocialSecurityNo;
	...
	public String getSocialSecurityNo(){
		return txtSocialSecurityNo.getText();
	}
	
	public JCMSTextField getSocialSecurityNoTxt() { // for getting the object
		return this.txtSocialSecurityNo;
	}
	
	public void setSocialSecurityNo(String sValue) {
		if (sValue == null || sValue.length() < 1)
			return;
		txtSocialSecurityNo.setText(sValue);
	}
	// changed by saptarshi mukhaty
	...
	public void setEnabled(boolean bEnabled) {
		...
		//added by vishal
		txtSocialSecurityNo.setEnabled(bEnabled);
...
//		 if (privacyRequired.equalsIgnoreCase("yes"))
	...
	private void jbInit() throws Exception {
		//added by vishal yevale
		//changed by saptarshi mukhaty
		lblSocialSecurityNo =new JCMSLabel("Social Security NO");
		txtSocialSecurityNo = new JCMSTextField();
...
//		Added for Field Date for Europe by Vivek
       ...
       //Added for Field Date for Europe by Vivek.
        ...
        //added by vishal yevale
        this.add(lblSocialSecurityNo, new GridBagConstraints(0, 13, 1, 1, 0.0, 0.0,GridBagConstraints.NORTHWEST,GridBagConstraints.NONE,new Insets(1, 1, 0, 6), 1,0));
        this.add(txtSocialSecurityNo, new GridBagConstraints(0, 14, 4, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL,new Insets(1, 1, 3, 1), 1, 1));
        }
