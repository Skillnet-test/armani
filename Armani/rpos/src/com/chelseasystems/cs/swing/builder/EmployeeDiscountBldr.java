...
public class EmployeeDiscountBldr implements IObjectBuilder {
  ...
  public void build(String Command, CMSApplet applet, Object initValue) {
    ...
    //sonali:Added for setting DiscountCode=EMPLOYEE_DISCOUNT.CODE
    //sonali:Added for reading discount code from ArmaniCommon.cfg
    //Insert Into Arm_Cfg_Detail (ty_CFG,Cd_Cfg,ED_CO,ED_LA,DE_CFG,priority) Values('EMPLOYEE_DISCOUNT','88','CN','zh','Employee','1');
    try{
    	String code = null ;
    if(discount!=null){
