...
public class InitialLoginApplet extends CMSApplet {
	...
	public void start() {
		...
		//Added to clear out the contents inside the Map created for sendsale. So that every time cashier logs in, the MAP contents is refreshed.
