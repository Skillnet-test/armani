...
//public class PaymentApplet extends JApplet {
{
	...
	private boolean postTransaction() throws BusinessRuleException {
		try {
			...
			// This code added from payment applet_eur to show actual card type on receipt
			//start-bug no 28463- on 29-09-2017-saptarshi
			...
			//Poonam:Ends here
			//end-bug no 28463- on 29-09-2017-saptarshi
			printReceipt();
			System.out.println("************************************************");
