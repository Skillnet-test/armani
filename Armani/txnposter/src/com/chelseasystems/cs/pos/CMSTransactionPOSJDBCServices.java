...
public class CMSTransactionPOSJDBCServices extends CMSTransactionPOSServices {
  ...
  protected ArmStgTxnHdrDAO armStgTxnHdrDAO;
...
//      statements.addAll(Arrays.asList(persistNewReservation(paymentTransaction)));
   ...
   * @throws SQLException
   */
  protected ParametricStatement[] persistCustomer(PaymentTransaction paymentTransaction)
      throws SQLException {
    List statements = new ArrayList();
   ...
   * @throws SQLException
   */
  protected ParametricStatement[] persistTransaction(PaymentTransaction paymentTransaction)
      throws SQLException {
    List statements = new ArrayList();
...
/*    	if (saleLineItem instanceof CMSItem) {
   ...
   */
  protected ParametricStatement[] persistNewLayaway(PaymentTransaction paymentTransaction)
...
//  }
   ...
   */
  protected ParametricStatement[] persistCustDepositHistory(PaymentTransaction paymentTransaction)
      throws SQLException, CurrencyException {
    List statements = new ArrayList();
    if (paymentTransaction instanceof CompositePOSTransaction) {
...
//            paymentTransaction).getCustomer(), hist.getamount()));
   ...
   * @throws Exception
   */
  protected ParametricStatement[] addLayawayPaymentTransaction(PaymentTransaction paymentTransaction)
      throws java.lang.Exception {
    List statements = new ArrayList();
   ...
   * @throws Exception
   */
  protected ParametricStatement[] updateLayawayForRTS(PaymentTransaction paymentTransaction)
      throws java.lang.Exception {
    List statements = new ArrayList();
   ...
   * @throws Exception
   */
  protected ParametricStatement[] updateRedeemableIssued(PaymentTransaction paymentTransaction)
      throws Exception {
    List statements = new ArrayList();
   ...
   * @throws CurrencyException
   */
  protected ParametricStatement[] persistRedeemable(PaymentTransaction paymentTransaction)
      throws SQLException, CurrencyException {
    List statements = new ArrayList();
    if (paymentTransaction instanceof CompositePOSTransaction) {
   ...
   * @throws SQLException
   */
  protected ParametricStatement[] persistNewDueBillIssue(PaymentTransaction paymentTransaction)
      throws SQLException {
    List statements = new ArrayList();
   ...
   * @throws CurrencyException
   */
  protected ParametricStatement[] undoForVoidTransaciton(PaymentTransaction paymentTransaction)
      throws SQLException, CurrencyException {
...
//        return (ParametricStatement[])statements.toArray(new ParametricStatement[0]);
   ...
   * @throws SQLException
   */
  protected ParametricStatement[] addToEmployeeSale(PaymentTransaction paymentTransaction)
      throws SQLException {
    List statements = new ArrayList();
    if (paymentTransaction instanceof VoidTransaction)
   ...
   * @throws SQLException
   */
  protected ParametricStatement[] updateRewardCards(PaymentTransaction paymentTransaction)
      throws SQLException {
